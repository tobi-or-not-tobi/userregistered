 ...
 */
package de.hybris.platform.userregistered.jalo;
...
import de.hybris.platform.userregistered.constants.UserregisteredConstants;



/**
 * This is the extension manager of the Userregistered extension.
 */
public class UserregisteredManager extends GeneratedUserregisteredManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(UserregisteredManager.class);
	 ...
	 */
	public static UserregisteredManager getInstance()
	{
		return (UserregisteredManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UserregisteredConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UserregisteredManager() // NOPMD 
	{
		LOG.debug("constructor of UserregisteredManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of UserregisteredManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of UserregisteredManager called, current tenant: {}", getTenant().getTenantID());
	}
